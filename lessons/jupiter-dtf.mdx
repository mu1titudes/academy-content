...
2. **Immediate Liquidity at the Token Generation Event (TGE)**. A portion of the sale proceeds is used at TGE to seed a liquidity pool on [Meteora](https://www.meteora.ag/), a leading [market maker](/lessons/automated-market-makers) in the Solana ecosystem. This gives buyers access to liquidity immediately upon launch, instead of having to wait for some exchange to list them.
...
**Stage 3: The Token Sale.** Each launch opens to buyers with one or more phases and criteria, driven by their own project's needs and community wants. Using HumidiFi (one of the largest AMMs on Solana) as a recent example, they launched their $WET token via DTF. The launch used three eligibility phases:
