...
A rug pull occurs when the creators of a project \- usually a new [token](http://academy.jup.ag/lessons/cryptocurreny#defining-the-asset-coins-vs-tokens) or DeFi protocol \- build up hype and liquidity, and then abruptly drain all the funds and disappear, leaving investors with worthless assets. Signs to watch for might include:
