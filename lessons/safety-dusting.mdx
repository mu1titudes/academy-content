...
A scammer mints a new token cheaply on Solana and mass-airdrops it to thousands of wallet addresses simultaneously. This costs them almost nothing - a single campaign may target tens of thousands to millions of wallets simultaneously. 
